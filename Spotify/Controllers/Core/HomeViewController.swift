...
class HomeViewController: UIViewController {
    ...
    private func fetchData() {
        // Featured Playlists, Reccomended Tracks, New Releases
        ...
        APICaller.shared.getRecomendedGenres {result in
            ...
            case .success(let model):
                ...
                APICaller.shared.getRecomendations(genres: seeds){ reccomendedResults in
                    defer {
                        group.leave()
                    }
                    switch reccomendedResults{
                    case .success(let model):
        ...
        group.notify(queue: .main){
            ...
            print("configureing view models")
...
extension HomeViewController: UICollectionViewDelegate, UICollectionViewDataSource{
    ...
    static func createSectionLayout(section: Int) -> NSCollectionLayoutSection{
        ...
        case 0:
            ...
            section.boundarySupplementaryItems = supplemenrtryViews
            return section
